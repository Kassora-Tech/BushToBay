  ...
  return (
    <section ref={ref} className="relative flex min-h-[100svh] items-end overflow-hidden bg-bush-950">
      ...
      >
        ...
        >
          <span aria-hidden="true" className="h-1.5 w-1.5 animate-pulse rounded-full bg-bay-400" />
        ...
        <h1 className="mt-7 max-w-4xl font-display font-bold tracking-tight text-white">
          ...
          <SplitText
            as="span"
            text="Bush to bay."
            className="block bg-gradient-to-r from-sand-200 via-bay-300 to-bay-400 bg-clip-text text-5xl leading-[1.08] text-transparent sm:text-7xl lg:text-8xl"
            delay={0.6}
          />
        </h1>
        ...
        >
          <Magnetic>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2.5 rounded-full bg-white px-8 py-4 font-semibold text-bush-900 shadow-xl shadow-black/25 transition-colors hover:bg-sand-100"
            >
              Get a Quote
